...
import 'package:piano_learn/midi_controller_page.dart';

class MidiSetupPage extends StatefulWidget {
  const MidiSetupPage({super.key});

  @override
  _MidiSetupPageState createState() => _MidiSetupPageState();
}

class _MidiSetupPageState extends State<MidiSetupPage> {
                  ...
                  return ListTile(
                    ...
                    onLongPress: () {
                      ...
                      Navigator.of(context)
                        ...
                        builder: (_) => MidiControllerPage(device),
                      ))
                          .then((value) {
                        setState(() {});
                      });
